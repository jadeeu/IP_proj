...
public class ConfrontManager : MonoBehaviour
{
    ...
    public int winPoints = 20;         // correct catch
    public int penaltyPoints = 7;      // wrong accusation
    ...
    public void ShowStagePopup()
    {
        if (stagePopup != null)
        {
            ...
            if (debugLogs) Debug.Log("[Confront] Stage popup shown.");
        }
    }
    ...
    void Update()
    {
        ...
        if (popupOpen)
        {
            ...
            {
                if (debugLogs) Debug.Log("[Confront] Reloading scene...");
